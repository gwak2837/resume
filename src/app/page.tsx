  ...
  return (
    <main className="mx-auto mb-8 max-w-[720px]">
      ...
      <p className="my-4 	">
        ...
        인턴, 신디(Sindy) 창업팀 프로토타입 개발팀장, (주)알파카살롱 MVP 개발팀장, (주)더하트컴퍼니
        개발팀장 등에서 다양한 프로젝트를 수행하며 서비스가 세상에 나오기 위한 전체 개발 주기를
        경험했습니다. 이 과정에서 서비스의 성공은 동료와의 협업과 서로의 성장에 기반한다는 사실을
        느꼈습니다.
      </p>
      <p className="my-4 	">
      ...
      <p className="my-4 	">
        아이디어를 프로토타입으로 변환하고, 그 프로토타입을 실제 서비스로 발전시키는 과정에서, 저희
        신디 팀원 모두는 함께 성장하였습니다. 그 결과, 저희는 '디저트 사랑자들의 정보 교류를 위한
        SNS형 디저트 정보 공유 플랫폼'을 성공적으로 출시할 수 있었습니다. 현재는 프론트엔드 분야를
